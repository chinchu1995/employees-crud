    ...
    <div class="container-fluid">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <form id="form" method="post" action="{{route('employees.update',$employee->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card-body">
                        <div id="app-msgs">
                            @if (session('status'))
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" name="name" class="form-control" value="{{$employee->name}}" placeholder="Enter Name">
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mb-1"><img src="{{url($employee->photo)}}" width="100"></div>
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="designation" class="form-control" >
                                        ...
                                        <option value="{{$designation->id}}" @if($designation->id==$employee->designation_id) selected @endif> {{$designation->title}} </option>
                                        @endforeach
                                    </select>
